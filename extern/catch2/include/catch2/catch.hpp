...
namespace Catch {
    ...
    Session::Session() {
        ...
        if( alreadyInstantiated ) {
            CATCH_TRY { CATCH_INTERNAL_ERROR( "Only one instance of Catch::SessionFile can ever be used" ); }
...
#if defined(CATCH_CONFIG_WCHAR) && defined(WIN32) && defined(UNICODE)
    int SessionFile::applyCommandLine( int argc, wchar_t const * const * argv ) {
